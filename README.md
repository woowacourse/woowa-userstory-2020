...
- **실내 사진 촬영을 했을 때의 장점이 있었나요?**
- **일반 스튜디오에서 사진 촬영을 했을 때 단점이 있었나요?**

#### 공간 대여자
- **본인 집을 공유한다면 어디까지 허용할 수 있나요?**
    - 허용하지 못하는 이유가 있을까요?
- **본인의 집을 공유한다면 가장 걱정 되는 부분이 있을까요?**
...
> 촬영장소와 사진작가에게 만족한 지은이는 티거의 장소와 알트에 대한 리뷰를 작성한다.
...
| 지은이는 친구들과 취업 기념 우정 사진을 찍기로 했는데 일반 스튜디오가 아닌 컨셉을 잡고 사진을 남기고 싶었다. <br /> 그러던 중 취업 준비를 했을 때 노트북을 들고 카페를 갔던 기억이 스치면서 카페에서 개발자 컨셉으로 사진을 찍으면 좋겠다고 생각했다. <br /> 그러던 중 장소 대여 플랫폼을 발견하고 티거가 운영하는 카페를 이용하게 된다. <br /> 그리고 알트라는 프리랜서 사진작가를 발견하고 채팅으로 연락했고 사진을 자신의 포트폴리오로 사용할 수 있도록 공개해 준다면 할인을 해준다고 하여, 할인을 받고 무사히 우정 사진을 찍게 되었다. <br /> 촬영장소와 사진작가에게 만족한 지은이는 티거의 장소와 알트에 대한 리뷰를 작성한다.   | - 장소와 프리랜서 사진작가의 리스트를 제공한다. <br /> - 결제 시스템을 제공한다. <br /> - 이용이 끝난 후 리뷰를 작성할 수 있도록 템플릿을 제공한다. |
